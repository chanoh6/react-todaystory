...
const AdViewerCp = React.memo(({ index }) => {
  ...
  useEffect(() => {
    setAdSlotId(`div-gpt-ad-1628051287147-${index}`);
    setAdUnitPath(`/284705699/Samsung_life/Samsung_KR_life_viewer_for_cp`);
    setAdSizes([[320, 50], 'fluid', [320, 100]]);
  }, [index, isGPTLoaded]);
